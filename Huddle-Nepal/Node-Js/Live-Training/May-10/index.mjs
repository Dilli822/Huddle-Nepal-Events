...
// it will be headache to know what is by hovering over mouse
// with yarn types we can know types -- to know types and functionality which is similar to Typescript

// fs.writeFile();



// ## URL (path locator) or url locator 
import { URL } from "url";
